...
Repozitár obsahuje izolovaný konektor, cez ktorý môže súkromný vlastný GPT vytvoriť úlohu v Nezabudni. Integrácia nemení existujúce klientské RPC, offline synchronizáciu ani `push-worker`; používa samostatnú Edge Function, revokovateľný token, idempotenciu a existujúcu notifikačnú frontu.
